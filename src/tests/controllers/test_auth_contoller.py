...
class TestAuthController:
    @patch.object(TokenManager, "create_access_token")
    ...
    @patch.object(PasswordManager, "hash_verify")
    def test_get_profile_success(
        ...
        user_service = UserRepository(db)
        user_service.create_user(UserCreate(**user_data))
        access_token = TokenManager().create_access_token({"sub": user_data["email"]})
